            ...
            <div className="max-w-7xl mx-auto px-6 md:px-10 flex items-center justify-between">
                ...
                <Link href="/" className="flex items-center gap-3 group">
                    ...
                    <div className="flex flex-col">
                        <span className="text-xl font-black tracking-tighter text-gray-900 leading-none">AIM<span className="text-emerald-500">S</span>TORS</span>
                        <span className="text-[8px] font-black text-emerald-600 uppercase tracking-[.4em] mt-1 ml-0.5 opacity-60">Official WhatsApp Platform</span>
                    </div>
                </Link>
                ...
                <div className="hidden lg:flex items-center lg:gap-4 xl:gap-6">
                    ...
                    <Link
                        ...
                        className="bg-black text-white px-6 xl:px-8 py-4 rounded-[18px] text-[10px] font-black uppercase tracking-[.2em] hover:bg-emerald-600 transition-all shadow-xl shadow-gray-400/20 flex items-center gap-3 group"
                    >
                        Start Free Trial
                ...
                <button
                    className="lg:hidden p-4 bg-gray-50 text-gray-900 rounded-2xl hover:bg-emerald-500 hover:text-white transition-all active:scale-90"
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="lg:hidden absolute top-full left-4 right-4 mt-4 bg-white rounded-[32px] border-2 border-gray-50 shadow-2xl overflow-hidden p-8"
                    >
