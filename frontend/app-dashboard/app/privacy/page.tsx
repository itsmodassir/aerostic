        ...
        <div className="min-h-screen bg-white">
            ...
            <main className="max-w-4xl mx-auto px-6 py-16">
                ...
                <div className="prose prose-lg max-w-none text-gray-600">
                    ...
                    <p>
                        Aimstors Solution ("we", "us", or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our WhatsApp Marketing SaaS platform.
                    </p>
