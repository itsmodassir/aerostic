        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg p-8 shadow-sm">
            <div className="prose prose-lg max-w-none">
              ...
              <p>
                By accessing and using Aimstors Solution AI, you accept and agree to be bound by the terms 
                and provision of this agreement.
              </p>

              <h2>Use License</h2>
              <p>
                Permission is granted to temporarily use Aimstors Solution AI for personal and commercial use. 
