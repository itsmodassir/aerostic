        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <Link to="/blog-editor" className="hover:text-white transition-colors">
                  AI Blog Editor
                </Link>
              </li>
              <li>
                <Link to="/blog-builder" className="hover:text-white transition-colors">
                  Website Builder
                </Link>
              </li>
              <li>
                <Link to="/deploy" className="hover:text-white transition-colors">
                  Deploy
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li>
                <a href="mailto:support@setmyblog.ai" className="hover:text-white transition-colors">
                  Support
                </a>
              </li>
            </ul>
