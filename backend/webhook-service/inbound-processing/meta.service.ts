    ...
    try {
      ...
      try {
        const debugRes = await axios.get(
          `https://graph.facebook.com/${await this.getApiVersion()}/debug_token`,
          {
            params: {
      ...
      if (!wabaId) {
        ...
        try {
          const businessesRes = await axios.get(
            `https://graph.facebook.com/${await this.getApiVersion()}/me/businesses`,
            {
          ...
          for (const business of businesses) {
            try {
              ...
              let wabaRes = await axios.get(
                `https://graph.facebook.com/${await this.getApiVersion()}/${business.id}/owned_whatsapp_business_accounts`,
                {
                  params: { access_token: accessToken },
                },
              );
              ...
              wabaRes = await axios.get(
                `https://graph.facebook.com/${await this.getApiVersion()}/${business.id}/client_whatsapp_business_accounts`,
                {
                  params: { access_token: accessToken },
                },
              );
      ...
      const phoneRes = await axios.get(
        `https://graph.facebook.com/${await this.getApiVersion()}/${wabaId}/phone_numbers`,
        {
          params: { access_token: accessToken },
        },
      );
