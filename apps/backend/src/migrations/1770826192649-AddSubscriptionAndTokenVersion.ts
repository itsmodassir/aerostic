...
export class AddSubscriptionAndTokenVersion1770826192649 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_0dc0a37e70cdb3c89a2160e79d" ON "razorpay_events" ("eventId") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tenants" ALTER COLUMN "subscription_status" SET DEFAULT 'trial'`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0dc0a37e70cdb3c89a2160e79d"`,
    );
