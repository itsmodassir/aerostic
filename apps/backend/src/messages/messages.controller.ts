...
export class MessagesController {
    ...
    @Post('send')
    async sendMessage(@UserTenant() tenantId: string, @Body() dto: SendMessageDto) {
    ...
    async getConversationMessages(@UserTenant() tenantId: string, @Param('id') conversationId: string) {
