...
import { MessageSquare, Zap, Split, FileText } from 'lucide-react';
...
export const TriggerNode = memo(({ data }: any) => {
    return (
        <NodeWrapper title="Trigger" icon={Zap} color="border-yellow-500">
            ...
            <div className="font-medium text-sm">{data.label || 'Incoming Message'}</div>
...
export const TemplateNode = memo(({ data }: any) => {
    return (
    ...
    return (
        <div className="min-w-[200px] bg-white rounded-lg shadow-md border-2 border-orange-500 overflow-hidden">
            ...
            <div className="p-4 relative">
                <div className="text-sm text-center mb-4">{data.condition || 'If...'}</div>
